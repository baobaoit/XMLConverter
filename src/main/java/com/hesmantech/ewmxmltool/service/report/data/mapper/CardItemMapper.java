...
public final class CardItemMapper {
    private CardItemMapper() {

    }

    public static Integer getColumnWidth(String fieldName) {
        CardItemField field = CardItemField.valueFrom(fieldName);
    ...
    private enum CardItemField {
        ...
        CardItemField(String name, int width, String columnHeaderText) {
            this.name = name;
            this.width = width;
            this.columnHeaderText = columnHeaderText;
        }

        public static CardItemField valueFrom(String fieldName) {
            for (CardItemField value : CardItemField.values()) {
