...
public class AccountTransactionItem {
    ...
    private String isConversionFeeBlended;
    ...
    private String epmMethodId;
    private String epmTransactionId;
    ...
    private Double transactionExchangeFeeAmount;
    private String transactionExchangeFeeAmountCurrency;
    ...
    public Double getTransactionExchangeFeeAmount() {
        return transactionExchangeFeeAmount;
    }

    public void setTransactionExchangeFeeAmount(Double transactionExchangeFeeAmount) {
        this.transactionExchangeFeeAmount = transactionExchangeFeeAmount;
    }

    public String getTransactionExchangeFeeAmountCurrency() {
        return transactionExchangeFeeAmountCurrency;
    }

    public void setTransactionExchangeFeeAmountCurrency(String transactionExchangeFeeAmountCurrency) {
        this.transactionExchangeFeeAmountCurrency = transactionExchangeFeeAmountCurrency;
    }
}
