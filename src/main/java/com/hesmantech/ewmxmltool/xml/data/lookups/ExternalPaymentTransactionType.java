...
@XmlRootElement(name = "ExternalPaymentTransactionType")
public class ExternalPaymentTransactionType extends AbstractLookupsElementFields implements LookupsCcAttribute {
