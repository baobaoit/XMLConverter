...
@XmlRootElement(name = "ExternalPaymentTransactionStatusCode")
public class ExternalPaymentTransactionStatusCode extends AbstractLookupsElementFields implements LookupsCcAttribute {
